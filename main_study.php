...
<body>
    ...
    <!------------------------------ SIDEBAR ------------------------------->
            ...
            <div class="sidebar">
                ...
                <a class="menu-item" href="main_save.php?username=<?php echo urlencode($username); ?>&userid=<?php echo urlencode($userid); ?>">
                        <span><i class="uil uil-bookmark"></i></span>
                        <h3 style="color:black">Save</h3>
                </a>
                <a class="menu-item active">
                    <span><i class="uil uil-chart-line"></i></span>
                    <h3>Video study Material</h3>
                </a>
    ...
    <!------------------------------ MIDDLE ------------------------------->
            ...
            <div class="middle">
                ...
                <form class="create-post" action="post3.php" method="post" enctype="multipart/form-data">
                    <div class="profile-photo">
                        <img src="<?php echo $imagePath ?>" alt="">
                    </div>
                            <input type="hidden" name="user_id" value="<?php echo $userid; ?>">
                            <input type="text" name="text" placeholder="link give please,<?php echo $_SESSION['user_name'] ?>?" id="create-post">
                        ...
                        while($row = mysqli_fetch_assoc($result1)) {
                            ...
                            if (mysqli_num_rows($result2) > 0) {
                                ...
                                echo  '<div class="feed"> 
                                                ...
                                                <div class="photo">
                                                <video width="800"  controls onerror="handleError(this)">
